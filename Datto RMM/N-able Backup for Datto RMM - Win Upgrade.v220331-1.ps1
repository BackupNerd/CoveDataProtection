...
<# ----- Behavior: ----
    ...
    # Checks for existing installation and exits if not found
    #          
...
if ((Test-Path "C:\Program Files\Backup Manager\config.ini" -PathType leaf) -eq $false) { Write-output "Backup Manager not found"; Break }
else{
