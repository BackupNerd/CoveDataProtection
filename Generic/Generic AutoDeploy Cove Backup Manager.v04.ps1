<## ----- About: ----
    # AutoDeploy N-able | Cove Data Protection | Backup Manager
    # Revision v04 - 2023-12-01
...
<# ----- Behavior: ----
    # Dowload and deploy a new Backup Manager as a Passphrase compatible device
...
param(
    [parameter()]
    [string]$UID = "fedf2a12-75b5-Sample111-5db60adaac11",      ## Partner UID Default unless overrided
    [string]$PROFILE_ID = "5038",                               ## '0' for no profile '5038' for Documents
    [string]$BACKUPPROFILE,                                     ## Case sensive profile name
    [string]$PRODUCT_NAME = "Documents",                        ## Case sensive product name 'Documents 
    [switch]$SET_BANDWIDTH,                                     ## Switch to Enable Bandwidth Throttle
    [switch]$SET_ARCHIVE,                                       ## Switch to Enable Archive
    [switch]$REMOVE_BACKUPMANAGER                               ## Switch to Remove Backup Manager
